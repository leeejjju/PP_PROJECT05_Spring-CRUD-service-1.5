...
public class UserDAO {
    ...
    public int insertUser(UserVO vo) {
        System.out.println("===> jdbcTemplate으로 insertUser() 기능 처리");
        return sqlSession.insert("UserDAO.insertUser", vo);
    }

    //D
    public int deleteUser(int seq) {
        System.out.println("===> jdbcTemplate으로 deleteUser() 기능 처리");
        return sqlSession.insert("UserDAO.deleteUser", seq);
    }

    //U
    public int updateUser(UserVO vo) {
        System.out.println("===> jdbcTemplate으로 updateUser() 기능 처리");
    ...
    public List<UserVO> getUserList(){
        System.out.println("===> jdbcTemplate으로 getUserList() 기능 처리");
